    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 via-white to-indigo-50">
      ...
      <nav className="container mx-auto px-6 py-6">
        <div className="flex items-center justify-between">
          ...
          >
            <a href="https://vision-talk.netlify.app/sign-in?redirect_url=https%3A%2F%2Fvision-talk.netlify.app%2F">Get Started</a>
          </motion.button>
        </div>
      </nav>
      ...
      <main className="container mx-auto px-6 pt-20 pb-12">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            ...
            >
              <a href="https://vision-talk.netlify.app/meeting/8854cc2c-221e-46f2-b087-be34be81b515">Schedule a Meeting</a>
